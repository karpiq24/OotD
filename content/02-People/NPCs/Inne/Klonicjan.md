---
title: Klonicjan
race: Człowiek (Simulacrum)
gender: Mężczyzna
occupation: Magiczny klon, wsparcie drużyny
image_prompt: Identical twin double of a young adult male human wizard with a lean, rugged build. He has intense blue-grey eyes, a strong jawline, a weathered complexion, and a prominent scar across his right cheek. His short, messy dark brown hair is complemented by a full dark brown beard. He wears layered medieval clothing, a rust-brown hooded tunic over a coarse off-white linen shirt, with a thick brown leather shoulder strap and buckle. He has a faint, subtle blueish magical aura, heroic fantasy style.
---

![Placeholder](../../../assets/placeholder.webp)

_Magiczny klon (Simulacrum) Felicjana Janusa Twardowskiego, stworzony ze śniegu i lodu._

## Opis
Klonicjan to idealny fizyczny duplikat maga [[Felicjan Janus Twardowski|Felicjana]], stworzony za pomocą potężnego zaklęcia *Stworzeniebowtóra (Simulacrum)*. Wizualnie różni się jedynie subtelną, chłodną aurą oraz zachowaniem, które jest bezpośrednio podporządkowane woli jego stwórcy. W walce wspiera drużynę potężnymi zaklęciami, takimi jak *Chromatyczna Kula (Chromatic Orb)*.

## Osobowość
Cichy, posłuszny i zorientowany na realizację celów Felicjana. Posiada tę samą inteligencję i wspomnienia co pierwowzór w momencie tworzenia.

...
W [[Sesja 83 - Bitwa o Mytros: Odejście Sturękiego]] nadszedł od wschodu na pola pod [[Mytros]], by pomścić zabite dzieci. Walczył metodycznie, bez gniewu — chwytał smoki i jeźdźców setką ramion, wlókł pochwyconych za sobą i połykał ich w całości; w jego trzewiach znaleźli się kolejno [[Versir]], [[Orion Xul|Orion]] i [[Arevon Elorrenthi|Arevon]]. Nie zdołało go powstrzymać ani zaklęcie wygnania [[Felicjan Janus Twardowski|Felicjana]], ani widmowy miecz losu, ani groźby [[Orestes|Orestesa]]. Przełamał go dopiero [[Versir]], który stanął przed nim ze [[Zlote Owoce|złotym owocem]] i w imię woli [[Thylea|Thylei]] rozkazał mu odejść: pięść wielkości okrętu zatrzymała się o włos nad jego głową. [[Kentimane]] uznał w bohaterach dzieci [[Thylea|Thylei]], które się nie ugięły, odwrócił pięćdziesiąt twarzy ku wschodowi i bez słowa odszedł ku morzu — jedyny z Tytanów, którego nie trzeba było zabić.

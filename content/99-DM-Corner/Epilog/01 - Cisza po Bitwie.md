...
*Cue: przeczytaj tylko ten, który pasuje do finału. Trzy–cztery zdania, nic więcej — reszta pliku jest wspólna.*
...
### Wariant B — Kentimane legł polem stu rąk

> *Ostatnia kamienna dłoń opada i zastyga, palcami ku niebu. Kurz idzie w górę i wisi w powietrzu tak długo, że zdąży się w nim zrobić jasno.*
>
> *Tam, gdzie stał Sturęki, jest teraz pole. Sto rąk wielkości wież, sterczących z ziemi w każdą stronę, każda zastygła w pół gestu. Ludzie będą tu przychodzić przez wieki i nikt nigdy nie ustali, czy te ręce prosiły, groziły, czy się broniły.*
>
> *A pośrodku, w rumowisku klatki piersiowej, żarzy się jedna rzecz, która nie skamieniała. Bryła gwiezdnego metalu wielkości beczki. Bije wolno, jak coś, co nie wie jeszcze, że umarło.*
>
> *Nikt do niej nie podchodzi. Jeszcze nie dziś.*

---

## 2. Pierwsza prawdziwa cisza nad Mytros (read-aloud)
...
>
> *Wasze uszy dzwonią. Ręce wam drżą i nie chcą przestać. Ktoś z was zdaje sobie sprawę, że wciąż stoi w pozycji, jakby miał zaraz uderzyć, i nie potrafi jej rozluźnić.*
>
> *Wojna się skończyła. Nikt tego jeszcze nie powiedział na głos.*

*Cue: zrób pauzę. Prawdziwą, kilkusekundową. Jeśli któryś z graczy odezwie się pierwszy — pozwól mu i odpowiedz. To jest właściwie już pierwsza scena epilogu.*
...
>
> **Brax** *(ciszej)*: „...ty nie oddychasz."
>
> *Pauza.*
>
> **Brax:** „No dobra. Wiesz co, mój dziadek też nie oddychał, jak pił. To rodzinne."
>
...
*Cue: jeśli [[Orestes]] siedzi w tej sesji przy stole, ta scena należy do niego i nie skracaj jej. Jeśli gracza nie ma — przenieś Braxa na [[Bullbug]] albo na kogokolwiek z minotaurów z [[Targ Minotaurów|Targu]] i zagraj to samo.*

---

## 4. Rachunek poległych (read-aloud)

*Cue: trzy kroki, z pauzą po każdym: **liczby → przeramowanie → zobowiązanie**. Nie łącz ich w jeden akapit. Liczba musi zdążyć zaboleć.*

> *Liczenie zajmuje sześć dni. Robią to skrybowie [[Akademia Mytros|Akademii]], bo jako jedyni w mieście umieją liczyć szybciej, niż przybywa ciał.*
>
...
> *Czterdzieści pięć tysięcy osiemset osiemdziesiąt dwie osoby żyją.*
>
...
>
> *Pomniki stawiają szybciej, niż powinni. Kamieniarze pracują z pamięci i pijani, więc podobizny są niepodobne, a napisy mają błędy. Nikt ich nie kuje od nowa. Za sto lat te błędy będą kanonem.*

**Kapliczki bohaterów.** *Cue: to jest właściwy punkt tej sekcji. Podaj to spokojnie, jako fakt, nie jako zaszczyt.*
...
>
> *Proszą o rzeczy, których nikt z was nigdy nie obiecał. O powrót męża spod Doków. O dziecko. O zdjęcie klątwy. O to, żeby brat przestał pić.*

> *I to jest rzecz, którą trzeba powiedzieć wprost: **czy przyjmiecie ten kult, czy nie — on już istnieje.** Nie potrzebuje waszej zgody, nie zapytał o nią i nie zapyta. Możecie go pobłogosławić, możecie go zignorować, możecie osobiście rozbić każdą kapliczkę w tym mieście. Postawią je z powrotem w tydzień, tylko bez waszej wiedzy.*
>
> *Jedyne, o czym możecie zdecydować, to czy ci ludzie będą się modlić do was, czy do opowieści o was.*

*Cue: to jest zaczepka pod `02 - Epilogi Bohaterów`. Nie rozstrzygaj jej tutaj. Jeśli ktoś zareaguje od razu — zapisz i wróć do tego w jego scenie.*
...
*Cue: zaproponuj ją komuś wprost, na oczach reszty. Odmowa jest tu równie mocnym wyborem jak przyjęcie.*
...
*Cue: **zacznij od Delphii, nie od skarbu.** Jeśli gracze pomyślą najpierw o złocie, nie prostuj tego — po prostu wspomnij, że przy niskim odpływie z tego masztu słychać śpiew.*

### Kolos Pythora i Berło Władzy
...
## 8. Postawienie zadania stołowi (read-aloud)

*Cue: to jest przejście do `02 - Epilogi Bohaterów`. Wyjdź z narracji w ostatnim akapicie i mów jako DM — świadomie, na oczach graczy. Potem ogłoś zasady „inicjatywy na uczucia" (patrz `00 - Jak prowadzić epilog`, sekcja 5).*

> *Trzy miesiące po ostatnim dniu wojny [[Kyrah]] przychodzi do was z księgą.*
>
> *Jest gruba, oprawiona w skórę, i w trzech czwartych zapisana. Ostatnie strony są puste. Kładzie ją na stole między wami i nie mówi, żebyście coś z nią zrobili — po prostu ją zostawia i siada obok.*
>
> **Kyrah:** „Doszłam do końca tego, co widziałam. Resztę muszę usłyszeć od was. I nie chodzi mi o to, jak zabiliście Tytana — to już mam, w trzech wersjach, wszystkie kłamią. Chodzi mi o to, co dalej."
>
> *Wieczór jest ciepły. Miasto pod wami odbudowuje się z hałasem, którego nikt już nie nazywa hałasem.*

> *A to, co musimy teraz ustalić — my, przy tym stole — to jest właśnie to.*
>
> *Nie kto wygrał. To już wiemy.*
>
> *Co się stało. I co się stanie.*

**→ Przechodzimy do `02 - Epilogi Bohaterów`.**
